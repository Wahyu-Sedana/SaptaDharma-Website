        ...
        <div>
                ...
                <section className="py-24">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <Link
                            ...
                            className="group mt-8 grid gap-0 overflow-hidden rounded-3xl bg-white dark:bg-slate-900 shadow-sm ring-1 ring-slate-900/5 dark:ring-white/10 transition hover:shadow-xl md:grid-cols-2"
                        >
                            ...
                            <div className="flex flex-col justify-center p-10">
                                <span className="inline-flex w-fit rounded-full bg-green-50 dark:bg-green-500/10 px-3 py-1 text-xs font-semibold text-green-600 uppercase">
                                    {featured_article.category?.name}
                                </span>
                                <h2 className="mt-4 text-2xl font-bold text-slate-900 dark:text-white transition group-hover:text-green-600">
                                    {featured_article.title}
                                </h2>
                                <p className="mt-3 text-sm leading-relaxed text-slate-500 dark:text-slate-400">{featured_article.excerpt}</p>
                            </div>
                        </Link>
                    </div>
                </section>
            ...
            <section className="bg-slate-50 dark:bg-slate-900/50 py-24">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <button
                            ...
                            className={`rounded-full px-4 py-2 text-sm font-medium transition ${
                                !category
                                    ...
                                    : 'bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400 ring-1 ring-slate-900/5 dark:ring-white/10 hover:bg-green-50 dark:hover:bg-green-500/10'
                            }`}
                        >
                            Semua
                        </button>
                    ...
                    {articles?.length === 0 ? (
                        <p className="text-slate-500 dark:text-slate-400">Belum ada artikel untuk kategori ini.</p>
                    ) : (
