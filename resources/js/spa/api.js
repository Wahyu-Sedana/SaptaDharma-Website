...
export const api = {
    ...
    historyHighlight: (slug, locale) => request(`/history/highlights/${slug}`, locale),
    ...
    location: (slug, locale) => request(`/locations/${slug}`, locale),
    wejangan: (locale) => request('/wejangan', locale),
};
